...
public class TakerLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_taker_login);
...
//                    }
        ...
        sign_in.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TakerLoginActivity.this, TakerNumberAuthentication.class);
                startActivity(intent);
                finish();
            }
        });
            ...
            public void onResponse(Call<LoginResponce> call, Response<LoginResponce> response) {
                if (response.isSuccessful()) {
                    ...
                    if (loginResponse != null && loginResponse.getStatus() == 1) {
                        ...
                        Toast.makeText(TakerLoginActivity.this, loginResponse.getUserId().toString(), Toast.LENGTH_SHORT).show();
                        ...
                        Intent intent = new Intent(TakerLoginActivity.this, TakerHomePage.class);
                        startActivity(intent);
                        finish();
...
//                        Toast.makeText(TakerLoginActivity.this, loginResponse.getStatus(), Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(Call<LoginResponce> call, Throwable t) {
                Toast.makeText(TakerLoginActivity.this, t.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
